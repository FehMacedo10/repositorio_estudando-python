# Loops -> São estruturas que executam blocos de código repetidas vezes até que a condição seja atendida
...
while resposta.upper == "S":
    ...
    input("Digite sua resposta [S/N]: ")

# Exemplo 2: Loop for para iterar sobre listas
# For In
fernanda_deve_pessoas = ["Amanda", "Tulani", "Renato", "Stephany", "Nathalia", "Camila", "Hayde", "Maria Eduarda"]

for item in fernanda_deve_pessoas:
    print(f"A Fernanda deve a(o) {item}")
...
lista_nomes = ["Fernanda", "João", "Felipe", "Ciclano", "Fulano", "beltrano", "zumano", "romano"]
